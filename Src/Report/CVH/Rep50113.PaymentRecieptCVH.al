report 50113 PaymentRecieptCVH
{
    Caption = 'Payment Reciept CVH';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/CustomerPaymentReceipt.rdl';
    ...
    dataset
    {
        dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
        {
            ...
            RequestFilterFields = "Customer No.", "Posting Date", "Document No.", "Document Type";
