report 50102 SalesShipmentCVH
{
    Caption = 'Sales Shipment CVH';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/SalesShipment.rdl';
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyPictures; CompanyInfo.Picture)
                    {
                    }
                    ...
                    dataitem(DimensionLoop1; "Integer")
                    {
                        ...
                        begin
                            if not ShowInternalInfo then
                                CurrReport.Break();
                            CompanyInfo.Picture := CompanyInfo.Picture;
                        end;
                    }
    ...
    begin
        ...
        CompanyInfo.Get();
        //CompanyInfo.SetPictureFromBlob(Picture);
